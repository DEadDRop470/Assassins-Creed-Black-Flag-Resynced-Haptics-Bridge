#!/usr/bin/env python3
"""Static audit for ACBFHapticsBridge v2.3.7.5 / v8-r9m."""
...
def audit_source(path: Path, failures: list[str]) -> None:
    ...
    checks = {
        "v8-r9m runtime": "v8-r9m-v2.3.7.5-1.06-1.07-compat" in source,
...
def audit_asi(path: Path, failures: list[str]) -> None:
    ...
    check(b"v8-r9m-v2.3.7.5-1.06-1.07-compat" in data,
