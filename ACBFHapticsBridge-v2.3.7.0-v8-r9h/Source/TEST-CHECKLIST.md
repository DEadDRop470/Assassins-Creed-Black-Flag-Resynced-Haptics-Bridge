# v8-r9h / v2.3.7.0 gameplay test checklist


## Version compatibility

- Steam TU 1.0.6 / voices38: native XInput observer verifies candidate IAT RVA `0x1D0119E0`.
- Ubisoft Connect: native XInput observer verifies candidate IAT RVA `0x1C5769E0`.
- Ubisoft+: native XInput observer verifies candidate IAT RVA `0x1EC409E0`.
- A candidate is patched only when its current pointer exactly equals the resolved `XInputSetState` export.
- Ubisoft Connect and Ubisoft+ supplied executables statically pass both fatal hook signatures and all 21/21 gameplay-state slots.
